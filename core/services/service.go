...
type LoginService interface {
	...
	LoginWithPrimaryContact(ctx context.Context, logger *zap.Logger, contactType contact.Type, principal string, password string, initiator string) (models.User, errors.RichError)
	...
	StartPasswordResetByPrimaryContact(ctx context.Context, logger *zap.Logger, contactType contact.Type, principal string, initiator string) (string, errors.RichError)
...
type UserService interface {
	...
	GetUserAndContactByConfirmedContact(ctx context.Context, logger *zap.Logger, contactType contact.Type, contactPrincipal string, initiator string) (models.User, models.Contact, errors.RichError)
	...
	RegisterUserAndPrimaryContact(ctx context.Context, logger *zap.Logger, contactType contact.Type, contactPrincipal, serviceName, initiator string) errors.RichError
	// GetUserPrimaryContact gets a users primary contact
	GetUserPrimaryContact(ctx context.Context, logger *zap.Logger, userID string, contactType contact.Type, initiator string) (models.Contact, errors.RichError)
	...
	GetUsersContactsOfType(ctx context.Context, logger *zap.Logger, userID string, contactType contact.Type, initiator string) ([]models.Contact, errors.RichError)
	// GetUsersConfirmedContactsOfType gets all of a users confirmed contacts of the given type
	GetUsersConfirmedContactsOfType(ctx context.Context, logger *zap.Logger, userID string, contactType contact.Type, initiator string) ([]models.Contact, errors.RichError)
